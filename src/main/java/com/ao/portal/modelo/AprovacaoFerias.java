...
public class AprovacaoFerias implements Serializable {
	...
	public AprovacaoFerias(Integer id, Date dataInicio, Date dataFim, Date dataPedido, int diasRestantes, Date anoLaboral) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AprovacaoFerias other = (AprovacaoFerias) obj;
		if (id == null) {
			if (other.id != null)
				return false;
